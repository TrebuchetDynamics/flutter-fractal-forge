...
Fractal Forge is an open-source Flutter explorer for mathematical systems and generative art. Browse **1004 production fractals**, tune parameters in real time, move through deep-zoom render paths, and export the views worth keeping.
...
- **Broad mathematical range** — 1004 production fractals across escape-time formulas, root-finding basins, strange attractors, IFS, cellular systems, tilings, space-filling curves, and ray-marched 3D forms.
