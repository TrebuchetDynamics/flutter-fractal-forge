...
- Live registry promoted ledger: `research/worlds-largest-fractal-catalog/curated-entry-ledger.live-registry.json` (generated research artifact). The live app has 965 production fractals plus 1 scientific visualization; the debug/test `ModuleRegistry` has 973 modules including 7 diagnostics.
