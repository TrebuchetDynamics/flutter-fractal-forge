...
![Fractal Forge title beside a violet and cyan recursive 3D form](feature_graphic.png)

## Phone screenshot sequence

| Explore the detail | Find your next fractal | Make the colors yours |
|---|---|---|
| ![Mandelbrot spirals with zoomed recursive detail and viewer controls](screenshots/phone/01-explore.png) | ![Fractal catalog with category filters and colorful preview cards](screenshots/phone/02-catalog.png) | ![Palette selection sheet with named color gradients](screenshots/phone/03-color.png) |

| Explore 3D forms | Keep and share your art | Bring a view to life |
|---|---|---|
| ![An orange Mandelbulb fractal rendered in three dimensions](screenshots/phone/04-3d.png) | ![Share and export choices for image export, a view link, sharing and wallpaper](screenshots/phone/05-export.png) | ![Camera looper with two keyframes ready to preview or export as GIF](screenshots/phone/06-animation.png) |
