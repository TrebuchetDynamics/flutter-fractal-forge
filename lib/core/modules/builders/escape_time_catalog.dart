...
final List<EscapeTimeConfig> escapeTimeCatalog = [
  ...
  // === Wave 1: Registered Orphan Shaders (80 entries) ===
  EscapeTimeConfig(
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // WAVE 4: Julia/Phoenix/Nova Family Expansion
  // ═══════════════════════════════════════════════════════════════════════════

  // ── Quaternion Julia 3D (2D slice) ────────────────────────────────────────
  EscapeTimeConfig(
  ...
  // ── Nova-style Variants for Root-Finding Fractals ────────────────────────
  // These add relaxation parameter control to standard root-finding methods
  ...
  // ── Julia Variants for Additional Powers ────────────────────────────────
  // Higher power variants that exist as shaders but may need catalog entries
  ...
  // ── Phoenix Variants (using available shaders) ──────────────────────────
  ...
  // ── Additional Multibrot/Multijulia Power Variants ──────────────────────
  ...
  // ── Additional Burning Ship Power Julia Variants ────────────────────────
  ...
  // ── Additional Celtic Power Variants ───────────────────────────────────
  ...
  // ── Additional Tricorn Power Variants ──────────────────────────────────
  ...
  // ── Additional Buffalo Power Variants ──────────────────────────────────
  ...
  // ── Additional Nova Degree Variants ────────────────────────────────────
  ...
  // ── Additional Mandelbar/Tricorn Variants ──────────────────────────────
