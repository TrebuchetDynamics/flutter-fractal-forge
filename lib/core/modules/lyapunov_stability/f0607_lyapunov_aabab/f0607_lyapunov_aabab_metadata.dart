...
@immutable
class F0607LyapunovAababMetadata {
  static const instance = F0607LyapunovAababMetadata._();
  const F0607LyapunovAababMetadata._();

  String get id => 'f0607_lyapunov_aabab';
  String get name => 'Lyapunov AABAB';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_AABAB',
    'Markus-Lyapunov AABAB',
  ];
