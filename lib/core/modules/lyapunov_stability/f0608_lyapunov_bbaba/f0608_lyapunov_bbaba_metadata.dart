...
@immutable
class F0608LyapunovBbabaMetadata {
  static const instance = F0608LyapunovBbabaMetadata._();
  const F0608LyapunovBbabaMetadata._();

  String get id => 'f0608_lyapunov_bbaba';
  String get name => 'Lyapunov BBABA';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_BBABA',
    'Markus-Lyapunov BBABA',
  ];
