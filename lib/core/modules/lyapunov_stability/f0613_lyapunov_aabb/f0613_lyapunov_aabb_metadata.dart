...
@immutable
class F0613LyapunovAabbMetadata {
  static const instance = F0613LyapunovAabbMetadata._();
  const F0613LyapunovAabbMetadata._();

  String get id => 'f0613_lyapunov_aabb';
  String get name => 'Lyapunov AABB';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_AABB',
    'Markus-Lyapunov AABB',
  ];
