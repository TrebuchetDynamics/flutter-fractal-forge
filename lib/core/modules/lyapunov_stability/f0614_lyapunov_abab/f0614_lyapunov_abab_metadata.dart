...
@immutable
class F0614LyapunovAbabMetadata {
  static const instance = F0614LyapunovAbabMetadata._();
  const F0614LyapunovAbabMetadata._();

  String get id => 'f0614_lyapunov_abab';
  String get name => 'Lyapunov ABAB';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_ABAB',
    'Markus-Lyapunov ABAB',
  ];
