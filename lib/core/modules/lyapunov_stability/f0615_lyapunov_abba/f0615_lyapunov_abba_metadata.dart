...
@immutable
class F0615LyapunovAbbaMetadata {
  static const instance = F0615LyapunovAbbaMetadata._();
  const F0615LyapunovAbbaMetadata._();

  String get id => 'f0615_lyapunov_abba';
  String get name => 'Lyapunov ABBA';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_ABBA',
    'Markus-Lyapunov ABBA',
  ];
