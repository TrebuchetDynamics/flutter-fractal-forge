...
@immutable
class F0617LyapunovAbbbMetadata {
  static const instance = F0617LyapunovAbbbMetadata._();
  const F0617LyapunovAbbbMetadata._();

  String get id => 'f0617_lyapunov_abbb';
  String get name => 'Lyapunov ABBB';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_ABBB',
    'Markus-Lyapunov ABBB',
  ];
