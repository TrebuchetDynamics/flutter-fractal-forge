...
@immutable
class F0621LyapunovAabbabMetadata {
  static const instance = F0621LyapunovAabbabMetadata._();
  const F0621LyapunovAabbabMetadata._();

  String get id => 'f0621_lyapunov_aabbab';
  String get name => 'Lyapunov AABBAB';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_AABBAB',
    'Markus-Lyapunov AABBAB',
  ];
