...
@immutable
class F0622LyapunovAbababMetadata {
  static const instance = F0622LyapunovAbababMetadata._();
  const F0622LyapunovAbababMetadata._();

  String get id => 'f0622_lyapunov_ababab';
  String get name => 'Lyapunov ABABAB';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_ABABAB',
    'Markus-Lyapunov ABABAB',
  ];
