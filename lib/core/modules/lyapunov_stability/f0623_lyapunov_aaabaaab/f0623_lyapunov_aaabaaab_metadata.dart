...
@immutable
class F0623LyapunovAaabaaabMetadata {
  static const instance = F0623LyapunovAaabaaabMetadata._();
  const F0623LyapunovAaabaaabMetadata._();

  String get id => 'f0623_lyapunov_aaabaaab';
  String get name => 'Lyapunov AAABAAAB';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_AAABAAAB',
    'Markus-Lyapunov AAABAAAB',
  ];
