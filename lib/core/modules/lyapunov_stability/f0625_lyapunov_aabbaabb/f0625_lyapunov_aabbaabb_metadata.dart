...
@immutable
class F0625LyapunovAabbaabbMetadata {
  static const instance = F0625LyapunovAabbaabbMetadata._();
  const F0625LyapunovAabbaabbMetadata._();

  String get id => 'f0625_lyapunov_aabbaabb';
  String get name => 'Lyapunov AABBAABB';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_AABBAABB',
    'Markus-Lyapunov AABBAABB',
  ];
