...
@immutable
class F0627LyapunovAabbbaaMetadata {
  static const instance = F0627LyapunovAabbbaaMetadata._();
  const F0627LyapunovAabbbaaMetadata._();

  String get id => 'f0627_lyapunov_aabbbaa';
  String get name => 'Lyapunov AABBBAA';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_AABBBAA',
    'Markus-Lyapunov AABBBAA',
  ];
