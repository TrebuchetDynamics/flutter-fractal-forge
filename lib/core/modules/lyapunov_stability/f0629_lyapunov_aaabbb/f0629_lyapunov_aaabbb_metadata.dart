...
@immutable
class F0629LyapunovAaabbbMetadata {
  static const instance = F0629LyapunovAaabbbMetadata._();
  const F0629LyapunovAaabbbMetadata._();

  String get id => 'f0629_lyapunov_aaabbb';
  String get name => 'Lyapunov AAABBB';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_AAABBB',
    'Markus-Lyapunov AAABBB',
  ];
