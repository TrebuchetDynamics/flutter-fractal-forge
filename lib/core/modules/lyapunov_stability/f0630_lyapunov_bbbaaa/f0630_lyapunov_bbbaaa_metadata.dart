...
@immutable
class F0630LyapunovBbbaaaMetadata {
  static const instance = F0630LyapunovBbbaaaMetadata._();
  const F0630LyapunovBbbaaaMetadata._();

  String get id => 'f0630_lyapunov_bbbaaa';
  String get name => 'Lyapunov BBBAAA';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_BBBAAA',
    'Markus-Lyapunov BBBAAA',
  ];
