...
@immutable
class F0632LyapunovAababbaMetadata {
  static const instance = F0632LyapunovAababbaMetadata._();
  const F0632LyapunovAababbaMetadata._();

  String get id => 'f0632_lyapunov_aababba';
  String get name => 'Lyapunov AABABBA';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_AABABBA',
    'Markus-Lyapunov AABABBA',
  ];
