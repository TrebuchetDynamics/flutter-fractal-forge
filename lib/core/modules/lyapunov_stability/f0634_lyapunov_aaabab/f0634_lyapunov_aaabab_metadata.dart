...
@immutable
class F0634LyapunovAaababMetadata {
  static const instance = F0634LyapunovAaababMetadata._();
  const F0634LyapunovAaababMetadata._();

  String get id => 'f0634_lyapunov_aaabab';
  String get name => 'Lyapunov AAABAB';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_AAABAB',
    'Markus-Lyapunov AAABAB',
  ];
