...
@immutable
class F0635LyapunovAbbabaMetadata {
  static const instance = F0635LyapunovAbbabaMetadata._();
  const F0635LyapunovAbbabaMetadata._();

  String get id => 'f0635_lyapunov_abbaba';
  String get name => 'Lyapunov ABBABA';
  String get category => 'Lyapunov & Stability';

  List<String> get aliases => const [
    'Lyap_ABBABA',
    'Markus-Lyapunov ABBABA',
  ];
