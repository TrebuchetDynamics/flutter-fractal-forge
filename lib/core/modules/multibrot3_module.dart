...
FractalModule buildMultibrot3Module() {
  final parameters = [
    FractalParameter(
  ...
  final defaultPreset = FractalPreset(
    id: 'multibrot3-default', moduleId: 'multibrot3', name: 'Default',
  ...
  return FractalModule(
    id: 'multibrot3',
    displayName: (l10n) => 'Multibrot d=3',
    dimension: FractalDimension.twoD,
    shaderAsset: 'shaders/multibrot3_gpu.frag',
    parameters: parameters,
    defaultPreset: defaultPreset,
    builtInPresets: [defaultPreset.copyWith(id: 'multibrot3-classic', name: 'Classic')],
