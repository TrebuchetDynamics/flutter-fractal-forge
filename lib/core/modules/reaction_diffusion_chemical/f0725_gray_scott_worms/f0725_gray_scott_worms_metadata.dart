...
@immutable
class F0725GrayScottWormsMetadata {
  static const instance = F0725GrayScottWormsMetadata._();
  const F0725GrayScottWormsMetadata._();

  String get id => 'f0725_gray_scott_worms';
  String get name => 'Gray-Scott Worms';
  String get category => 'Reaction-Diffusion & Chemical';

  List<String> get aliases => const [
    'Gray-Scott F=0.042 k=0.059',
  ];
