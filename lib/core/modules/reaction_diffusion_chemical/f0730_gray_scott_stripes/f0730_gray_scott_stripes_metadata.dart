...
@immutable
class F0730GrayScottStripesMetadata {
  static const instance = F0730GrayScottStripesMetadata._();
  const F0730GrayScottStripesMetadata._();

  String get id => 'f0730_gray_scott_stripes';
  String get name => 'Gray-Scott Stripes';
  String get category => 'Reaction-Diffusion & Chemical';

  List<String> get aliases => const [
    'Gray-Scott F=0.022 k=0.051',
  ];
