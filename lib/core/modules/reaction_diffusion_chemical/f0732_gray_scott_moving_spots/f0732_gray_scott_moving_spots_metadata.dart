...
@immutable
class F0732GrayScottMovingSpotsMetadata {
  static const instance = F0732GrayScottMovingSpotsMetadata._();
  const F0732GrayScottMovingSpotsMetadata._();

  String get id => 'f0732_gray_scott_moving_spots';
  String get name => 'Gray-Scott Moving Spots';
  String get category => 'Reaction-Diffusion & Chemical';

  List<String> get aliases => const [
    'Gray-Scott F=0.014 k=0.045',
  ];
