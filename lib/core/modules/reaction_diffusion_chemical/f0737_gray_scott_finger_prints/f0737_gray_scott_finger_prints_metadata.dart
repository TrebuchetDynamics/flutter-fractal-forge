...
@immutable
class F0737GrayScottFingerPrintsMetadata {
  static const instance = F0737GrayScottFingerPrintsMetadata._();
  const F0737GrayScottFingerPrintsMetadata._();

  String get id => 'f0737_gray_scott_finger_prints';
  String get name => 'Gray-Scott Finger Prints';
  String get category => 'Reaction-Diffusion & Chemical';

  List<String> get aliases => const [
    'Gray-Scott F=0.04 k=0.06',
  ];
