...
@immutable
class F0738GrayScottGiraffeMetadata {
  static const instance = F0738GrayScottGiraffeMetadata._();
  const F0738GrayScottGiraffeMetadata._();

  String get id => 'f0738_gray_scott_giraffe';
  String get name => 'Gray-Scott Giraffe';
  String get category => 'Reaction-Diffusion & Chemical';

  List<String> get aliases => const [
    'Gray-Scott F=0.034 k=0.063',
  ];
