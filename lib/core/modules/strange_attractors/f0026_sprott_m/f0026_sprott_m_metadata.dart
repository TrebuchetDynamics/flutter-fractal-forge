...
@immutable
class F0026SprottMMetadata {
  static const instance = F0026SprottMMetadata._();
  const F0026SprottMMetadata._();

  String get id => 'f0026_sprott_m';
  String get name => 'Sprott M';
