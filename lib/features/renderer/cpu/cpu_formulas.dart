...
final Map<String, CpuFormula> cpuFormulasByModuleId = <String, CpuFormula>{
  ...
  'complex_henon_julia_slice': _cpu_complex_henon_julia_slice,
  'matrix_logistic_spectrum': _cpu_matrix_logistic_spectrum,
  ...
  'gerhardt_schuster_tyson_ca': _cpu_gerhardt_schuster_tyson_ca,
  'klausmeier_vegetation': _cpu_klausmeier_vegetation,
  'mimura_murray_predator_prey': _cpu_mimura_murray_predator_prey,
  'stable_square_turing_model': _cpu_stable_square_turing_model,
  'flow_lenia': _cpu_flow_lenia,
  'coupled_logistic_map_lattice': _cpu_coupled_logistic_map_lattice,
  ...
  'implicit_affine_fractal_surface': _cpu_implicit_affine_fractal_surface,
