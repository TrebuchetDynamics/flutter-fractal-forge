...
CpuIteratorResult _iterDeltoid(
  ...
  // Matches cpu_formulas.dart (ported from shaders/escape_time_family/polynomial_maps/deltoid_gpu.frag)
  final cx = x;
  final cy = y;
...
CpuIteratorResult _iterEisenstein(
  ...
  // Matches cpu_formulas.dart (ported from shaders/escape_time_family/polynomial_maps/eisenstein_gpu.frag)
