...
const categoryToTargetFamily = {
  ...
  'Scientific Visualization': 'number_theory_special_functions',
  'Image Tessellations': 'escape_time_polynomial_complex',
  'Procedural Fractals': 'ifs_geometric',
  'Fractalish Motion': 'ifs_geometric',
...
const categoryToIdentityType = {
  ...
  'Lyapunov / Stability': 'map',
  'Number Theory': 'map',
  'Scientific Visualization': 'map',
  'Image Tessellations': 'map',
  'Procedural Fractals': 'transform_system',
  'Fractalish Motion': 'transform_system',
  'L-Systems': 'grammar',
  'Cellular / Stochastic': 'rule',
  'Root Finding': 'map',
