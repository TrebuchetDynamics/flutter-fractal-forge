...
// Cosecant Julia: z_{n+1} = csc(z^2) + c, c fixed via uniforms.
// csc(z) = 1/sin(z) in complex arithmetic.
...
uniform float uCReal;         // 10
uniform float uCImag;         // 11
