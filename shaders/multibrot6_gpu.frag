...
// Multibrot degree 6: z_{n+1} = z^6 + c.
// The sixth-power map has 5 critical points, producing a parameter space
// with 5-fold rotational symmetry. The main cardioid is surrounded by
// five primary bulbs and the filaments exhibit characteristic 5-armed
// star branching at Misiurewicz points.
// Derivative: dz/dc = 6z^5·der + 1 for normal-map shading.
