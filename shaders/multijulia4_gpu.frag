...
// Multijulia degree 4: z_{n+1} = z^4 + c, c = (0.25, 0.52).
// Julia set of the quartic Mandelbrot map — pixel = z₀, c is fixed.
// Degree-4 maps have 3 critical points (at the cube-roots of 0), giving
// a 3-fold family of Julia "quadrants". Near c=(0.25, 0.52) the set
// has a characteristic 4-pronged star shape with delicate filigree.
// Derivative dz/dz₀ = 4z³·der for normal-map shading (colorScheme 50-63).
uniform float uTime;
...
void main() {
  ...
  vec2 c   = vec2(0.25, 0.52);   // fixed Julia parameter
