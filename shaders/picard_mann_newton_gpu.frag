...
// Picard-Mann-Newton iteration on z^3 - 1.
// N(z) = z - f(z)/f'(z)  (Newton map)
// y = (1 - alpha)*z + alpha*N(z)
// z_new = N(y)
// Extra param: alpha (slot 10, default 0.5)
...
uniform float uAlpha;         // 10 (default 0.5)
