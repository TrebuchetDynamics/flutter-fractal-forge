...
// Sprott B — from Sprott (1994) "Some simple chaotic flows", case B.
// dx/dt = yz,  dy/dt = x − y,  dz/dt = 1 − xy.
// One of 19 algebraically-simple 3D ODE systems that exhibit chaos.
// Pixel (x,y) is the starting point; z is time-animated; Euler integration
// with dt=0.02 traces the orbit and accumulates a density coloring.
uniform float uTime;
