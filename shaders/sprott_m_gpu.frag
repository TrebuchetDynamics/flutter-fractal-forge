...
// Sprott M — from Sprott (1994) "Some simple chaotic flows", case M.
// dx/dt = -z, dy/dt = -x^2 - y, dz/dt = 1.7 + 1.7*x + y.
...
void main() {
  ...
  float x = p.x;
  float y = p.y;
  float z = 0.5 + 0.2 * sin(0.0015 * uTime) + 0.1 * p.y;
