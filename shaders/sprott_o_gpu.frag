...
// Sprott O — from Sprott (1994) "Some simple chaotic flows", case O.
// dx/dt = y, dy/dt = x - z, dz/dt = x + x*z + 2.7*y.
...
void main() {
  ...
  float x = p.x;
  float y = p.y;
  float z = 0.4 + 0.2 * sin(0.0013 * uTime) + 0.1 * p.y;
