...
// Sprott N — from Sprott (1994) "Some simple chaotic flows", case N.
// dx/dt = -2*y, dy/dt = x + z^2, dz/dt = 1 + y - 2*z.
...
void main() {
  ...
  float x = p.x;
  float y = p.y;
  float z = 0.3 + 0.25 * sin(0.0011 * uTime) + 0.12 * p.x;
