...
// Tangent Mandelbrot: z_{n+1} = tan(z) + c
// Transcendental fractal with poles at z = (n+½)π; produces cactus-spine and
// peacock-fan shapes along the real axis with rich self-similar boundary detail.
// Derivative: d(tan(z))/dc = (1 + tan²(z))·der + 1  (sec² identity).
