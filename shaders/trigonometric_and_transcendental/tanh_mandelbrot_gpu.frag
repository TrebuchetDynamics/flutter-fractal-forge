...
// Tanh Mandelbrot: z_{n+1} = tanh(z) + c
// Hyperbolic tangent iteration; tanh maps ℂ → (−1,1)×ℂ so the connected set
// is much denser near the real axis. Produces smooth comma-shaped bulbs.
// Derivative: d(tanh(z))/dc = sech²(z)·der + 1 = (1−tanh²(z))·der + 1.
