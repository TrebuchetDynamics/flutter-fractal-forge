...
// Weierstrass Elliptic Fractal: z_{n+1} = P(z) + c
// P(z) is the Laurent approximation of Weierstrass P-function:
//   P(z) ~ 1/z^2 + g2*z^2/20 + g3*z^4/28
// Extra param: g2 at slot 10 (default 4.0)
...
void main() {
  ...
  for (int j = 0; j < MAX_ITERS; j++) {
    ...
    // P(z) ~ 1/z^2 + g2*z^2/20 + g3*z^4/28
    vec2 z2 = cx_mul(z, z);
    vec2 z4 = cx_mul(z2, z2);
    vec2 inv_z2 = cx_div(vec2(1.0, 0.0), z2);
    vec2 pz = inv_z2 + (g2 / 20.0) * z2 + (g3 / 28.0) * z4;
    z = pz + c;
