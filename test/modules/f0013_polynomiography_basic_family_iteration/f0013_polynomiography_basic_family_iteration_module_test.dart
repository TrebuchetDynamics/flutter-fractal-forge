...
import 'package:flutter_fractal_forge/core/modules/newton_root_finding/f0013_polynomiography_basic_family_iteration/f0013_polynomiography_basic_family_iteration_module.dart';
...
void main() {
  test('F0013PolynomiographyBasicFamilyIteration instantiates', () {
    ...
    expect(m.shader, 'shaders/f0013_polynomiography_basic_family_iteration_gpu.frag');
  });
