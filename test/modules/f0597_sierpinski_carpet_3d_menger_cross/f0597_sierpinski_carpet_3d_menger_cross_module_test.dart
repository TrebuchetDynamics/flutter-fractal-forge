...
import 'package:flutter_fractal_forge/core/modules/3d_raymarching_hypercomplex/f0597_sierpinski_carpet_3d_menger_cross/f0597_sierpinski_carpet_3d_menger_cross_module.dart';
...
void main() {
  test('F0597SierpinskiCarpet3dMengerCross instantiates', () {
    ...
    expect(m.shader, 'shaders/f0597_sierpinski_carpet_3d_menger_cross_gpu.frag');
  });
