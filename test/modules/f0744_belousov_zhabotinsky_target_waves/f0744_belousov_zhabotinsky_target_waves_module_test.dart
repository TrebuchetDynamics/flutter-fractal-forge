...
import 'package:flutter_fractal_forge/core/modules/reaction_diffusion_chemical/f0744_belousov_zhabotinsky_target_waves/f0744_belousov_zhabotinsky_target_waves_module.dart';
...
void main() {
  test('F0744BelousovZhabotinskyTargetWaves instantiates', () {
    ...
    expect(m.shader, 'shaders/f0744_belousov_zhabotinsky_target_waves_gpu.frag');
  });
