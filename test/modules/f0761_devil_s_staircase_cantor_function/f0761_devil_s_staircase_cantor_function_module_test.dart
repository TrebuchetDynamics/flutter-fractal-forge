...
import 'package:flutter_fractal_forge/core/modules/number_theory_fractals/f0761_devil_s_staircase_cantor_function/f0761_devil_s_staircase_cantor_function_module.dart';
...
void main() {
  test('F0761DevilSStaircaseCantorFunction instantiates', () {
    ...
    expect(m.shader, 'shaders/f0761_devil_s_staircase_cantor_function_gpu.frag');
  });
