...
import 'package:flutter_fractal_forge/core/modules/escape_time_complex_plane/f1155_orbit_trap_circle_pickover_stalks/f1155_orbit_trap_circle_pickover_stalks_module.dart';
...
void main() {
  test('F1155OrbitTrapCirclePickoverStalks instantiates', () {
    ...
    expect(m.shader, 'shaders/f1155_orbit_trap_circle_pickover_stalks_gpu.frag');
  });
