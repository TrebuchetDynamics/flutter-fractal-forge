...
import 'package:flutter_fractal_forge/core/modules/escape_time_complex_plane/f1180_smooth_iteration_coloring_continuous/f1180_smooth_iteration_coloring_continuous_module.dart';
...
void main() {
  test('F1180SmoothIterationColoringContinuous instantiates', () {
    ...
    expect(m.shader, 'shaders/f1180_smooth_iteration_coloring_continuous_gpu.frag');
  });
