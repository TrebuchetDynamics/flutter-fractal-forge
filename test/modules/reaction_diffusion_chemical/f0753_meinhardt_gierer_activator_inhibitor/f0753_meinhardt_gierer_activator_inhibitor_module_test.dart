...
import 'package:flutter_fractals/core/modules/reaction_diffusion_chemical/f0753_meinhardt_gierer_activator_inhibitor/f0753_meinhardt_gierer_activator_inhibitor_module.dart';
...
void main() {
  test('F0753MeinhardtGiererActivatorInhibitor instantiates', () {
    ...
    expect(m.shader,
        'shaders/f0753_meinhardt_gierer_activator_inhibitor_gpu.frag');
  });
